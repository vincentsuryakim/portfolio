...
export interface ExperienceCardProps { imgSrc: string, title: string, role: string, time: string, short?: Array<string>}

const ExperienceCard: React.FC<ExperienceCardProps> = ({ imgSrc, title, role, time, short }) => {
    return (
        <div className="bg-white shadow-xl rounded-md px-8 lg:px-4 py-4">
            ...
            <button className="w-full mt-4 py-2 px-4 text-blue-900 text-sm font-medium rounded-md bg-blue-100 hover:bg-blue-200">View More</button>
        </div>
    );
}
